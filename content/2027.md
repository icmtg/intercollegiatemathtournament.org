+++
title = "Intercollegiate Math Tournament 2027"
template = "2027.html"
+++

<div class="not-prose bg-gradient-to-r from-blue-50 to-blue-100 border border-blue-400 text-gray-900 font-semibold px-6 py-3 rounded-md text-center">
  Registration is not yet open. Join our mailing list to be notified when it opens!
</div>


The Intercollegiate Math Tournament is pleased to announce its upcoming event
at the University of California, Berkeley.

**Compete for <span>$</span>20,000 in cash prizes, including a <span>$</span>8,000 top prize!**
...
<!-- {% button_link(href="https://contestdojo.com/public/QWNc7mV10T6UthqDOdMB") %}
Register on ContestDojo
{% end %} -->

<!-- {% button_link(href="https://docs.google.com/document/d/1Yko63TD92sHNggqFc49-wH9TzQWeENNwZWp0e1IYGKY/edit") %}
Registration Guide
{% end %} -->

## Registration Timeline

We will provide more registration details as we get closer to the tournament!
...
| ------------ | -------------------- | ----------------- | --------------------------------- |
| 10/15 – 12/1 | Regular Registration | <span>$</span>15  | Tournament shirts included.       |
| 12/1 – 1/31  | Late Registration    | <span>$</span>25  | Tournament shirts not guaranteed. |
...
- **Division A** (for experienced competitors): In addition to the Division B
  ...
  analysis, as well as other undergraduate subjects. **Division A teams compete
  for a <span>$</span>20,000 cash prize pool, with the top prize of <span>$</span>8,000.**
...
Don’t worry! You can register yourself as a solo team and we will merge incomplete teams before the competition, or you can use our [teammate finder](https://docs.google.com/spreadsheets/d/1npdgPPIJYfDzGt0NDtOeQe4_5F-Z9sJEZGmy958ycAM/edit?gid=0#gid=0).

## How to Register

Registration, team assignments, waiver signing, and score reports are managed
through [ContestDojo](https://contestdojo.com/), our online competition
platform. For step-by-step instructions, review the [ContestDojo registration
guide](https://docs.google.com/document/d/1Yko63TD92sHNggqFc49-wH9TzQWeENNwZWp0e1IYGKY/edit?tab=t.0).
...
- A [TBD] stipend, intended for one night of lodging (Friday)
...
<!-- **Financial aid applications will be accepted until December 15, and considered
on a rolling basis subject to remaining budget afterwards.** -->

Terms and conditions of financial aid:

<!-- - Financial aid will be provided on a reimbursement basis for:
  - Individual student tickets (<span>$</span>15 or <span>$</span>25)
  - <span>$</span>250 stipend, intended for Friday night lodging. **A maximum of 2 students
    per team will be offered this stipend.**
  - _ICMT is unfortunately unable to reimburse students for flights or other travel at this time._ -->
- Recipients of financial aid are required to check-in in the morning and
  **attend all rounds** of the competition.
- Students must abide by the rules of the competition and must not be
  disqualified for any form of academic dishonesty or cheating.
...
<!-- Priority financial aid decisions will be finalized on **December 22, 2025**.
Students will be notified of all decisions via email, and will have to accept
financial aid by **December 25, 2025 at 11:59 PM PT.** -->
...
No. Due to university campus policies, minors are not permitted to compete.
...
No. ICMT 2027 will be offered exclusively as an in-person event.
