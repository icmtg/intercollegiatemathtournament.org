...
<div class="not-prose bg-gradient-to-r from-blue-50 to-blue-100 border border-blue-400 text-gray-900 font-semibold px-6 py-3 rounded-md text-center">
  📋 Tournament day logistics have been posted! Check the <a href="/friday-night/" class="text-blue-600 underline">Friday Night</a> and <a href="/logistics/" class="text-blue-600 underline">Logistics</a> tabs for details.
</div>
